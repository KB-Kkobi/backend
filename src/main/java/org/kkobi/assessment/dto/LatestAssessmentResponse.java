...
@Getter
public class LatestAssessmentResponse {
    ...
    public LatestAssessmentResponse(AssessmentResultDetails resultDetails) {
        this.resultId = resultDetails.getResultId();
        this.personaCode = resultDetails.getAxisCode();
        this.typeName = resultDetails.getPersonaName();
        ...
        this.scores = new Scores(
                resultDetails.getRtScore(),
                resultDetails.getLhScore(),
                resultDetails.getRpScore()
        );
