...
public class AssessmentResultService {
    ...
    public AssessmentResult saveAssessmentResult(
            ...
            List<RuleResult> appliedRules) {
        PersonaType personaType = personaClassifier.calculatePersona(assessmentScore);
        Long personaId = assessmentMapper.getPersonaIdByName(personaType.getPersonaName());
        if (personaId == null) {
            throw new IllegalStateException("투자 성향 기준 정보를 찾을 수 없습니다: " + personaType.getPersonaName());
        }
